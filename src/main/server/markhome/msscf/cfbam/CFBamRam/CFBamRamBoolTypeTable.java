...
// Description: Java 11 in-memory RAM DbIO implementation for BoolType.
	...
	implements ICFBamBoolTypeTable
{
	...
	public CFBamRamBoolTypeTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamBoolTypeBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a80e" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a80e" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamBoolTypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamBoolTypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamBoolTypeBuff buff;
		ArrayList<CFBamBoolTypeBuff> filteredList = new ArrayList<CFBamBoolTypeBuff>();
		CFBamBoolTypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamBoolTypeBuff buff;
		ArrayList<CFBamBoolTypeBuff> filteredList = new ArrayList<CFBamBoolTypeBuff>();
		CFBamBoolTypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamBoolTypeBuff buff;
		ArrayList<CFBamBoolTypeBuff> filteredList = new ArrayList<CFBamBoolTypeBuff>();
		CFBamBoolTypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamBoolTypeBuff buff;
		ArrayList<CFBamBoolTypeBuff> filteredList = new ArrayList<CFBamBoolTypeBuff>();
		CFBamBoolTypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamBoolTypeBuff buff;
		ArrayList<CFBamBoolTypeBuff> filteredList = new ArrayList<CFBamBoolTypeBuff>();
		CFBamBoolTypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamBoolTypeBuff buff;
		ArrayList<CFBamBoolTypeBuff> filteredList = new ArrayList<CFBamBoolTypeBuff>();
		CFBamBoolTypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamBoolTypeBuff buff;
		ArrayList<CFBamBoolTypeBuff> filteredList = new ArrayList<CFBamBoolTypeBuff>();
		CFBamBoolTypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	/**
	 *	Read a page array of the specific BoolType buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamBoolTypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		return( (CFBamBoolTypeBuff)editCur );
	}
