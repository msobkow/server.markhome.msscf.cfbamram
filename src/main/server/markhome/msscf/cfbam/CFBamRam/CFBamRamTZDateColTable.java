...
// Description: Java 11 in-memory RAM DbIO implementation for TZDateCol.
	...
	implements ICFBamTZDateColTable
{
		...
		CFBamTZDateColBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a863" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a863" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamTZDateColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamTZDateColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamTZDateColBuff buff;
		ArrayList<CFBamTZDateColBuff> filteredList = new ArrayList<CFBamTZDateColBuff>();
		CFBamTZDateColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamTZDateColBuff buff;
		ArrayList<CFBamTZDateColBuff> filteredList = new ArrayList<CFBamTZDateColBuff>();
		CFBamTZDateColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamTZDateColBuff buff;
		ArrayList<CFBamTZDateColBuff> filteredList = new ArrayList<CFBamTZDateColBuff>();
		CFBamTZDateColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamTZDateColBuff buff;
		ArrayList<CFBamTZDateColBuff> filteredList = new ArrayList<CFBamTZDateColBuff>();
		CFBamTZDateColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamTZDateColBuff buff;
		ArrayList<CFBamTZDateColBuff> filteredList = new ArrayList<CFBamTZDateColBuff>();
		CFBamTZDateColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamTZDateColBuff buff;
		ArrayList<CFBamTZDateColBuff> filteredList = new ArrayList<CFBamTZDateColBuff>();
		CFBamTZDateColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamTZDateColBuff buff;
		ArrayList<CFBamTZDateColBuff> filteredList = new ArrayList<CFBamTZDateColBuff>();
		CFBamTZDateColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	 ...
	 */
	public CFBamTZDateColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
