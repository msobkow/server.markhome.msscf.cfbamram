...
// Description: Java 11 in-memory RAM DbIO implementation for NmTokenType.
	...
	implements ICFBamNmTokenTypeTable
{
		...
		CFBamNmTokenTypeBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a82a" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a82a" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamNmTokenTypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamNmTokenTypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamNmTokenTypeBuff buff;
		ArrayList<CFBamNmTokenTypeBuff> filteredList = new ArrayList<CFBamNmTokenTypeBuff>();
		CFBamNmTokenTypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamNmTokenTypeBuff buff;
		ArrayList<CFBamNmTokenTypeBuff> filteredList = new ArrayList<CFBamNmTokenTypeBuff>();
		CFBamNmTokenTypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamNmTokenTypeBuff buff;
		ArrayList<CFBamNmTokenTypeBuff> filteredList = new ArrayList<CFBamNmTokenTypeBuff>();
		CFBamNmTokenTypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamNmTokenTypeBuff buff;
		ArrayList<CFBamNmTokenTypeBuff> filteredList = new ArrayList<CFBamNmTokenTypeBuff>();
		CFBamNmTokenTypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamNmTokenTypeBuff buff;
		ArrayList<CFBamNmTokenTypeBuff> filteredList = new ArrayList<CFBamNmTokenTypeBuff>();
		CFBamNmTokenTypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamNmTokenTypeBuff buff;
		ArrayList<CFBamNmTokenTypeBuff> filteredList = new ArrayList<CFBamNmTokenTypeBuff>();
		CFBamNmTokenTypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamNmTokenTypeBuff buff;
		ArrayList<CFBamNmTokenTypeBuff> filteredList = new ArrayList<CFBamNmTokenTypeBuff>();
		CFBamNmTokenTypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	 ...
	 */
	public CFBamNmTokenTypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
