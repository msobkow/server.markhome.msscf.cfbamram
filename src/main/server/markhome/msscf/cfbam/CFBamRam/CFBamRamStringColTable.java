...
// Description: Java 11 in-memory RAM DbIO implementation for StringCol.
	...
	implements ICFBamStringColTable
{
	...
	public CFBamRamStringColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamStringColBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a862" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a862" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamStringColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamStringColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamStringColBuff buff;
		ArrayList<CFBamStringColBuff> filteredList = new ArrayList<CFBamStringColBuff>();
		CFBamStringColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamStringColBuff buff;
		ArrayList<CFBamStringColBuff> filteredList = new ArrayList<CFBamStringColBuff>();
		CFBamStringColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamStringColBuff buff;
		ArrayList<CFBamStringColBuff> filteredList = new ArrayList<CFBamStringColBuff>();
		CFBamStringColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamStringColBuff buff;
		ArrayList<CFBamStringColBuff> filteredList = new ArrayList<CFBamStringColBuff>();
		CFBamStringColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamStringColBuff buff;
		ArrayList<CFBamStringColBuff> filteredList = new ArrayList<CFBamStringColBuff>();
		CFBamStringColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamStringColBuff buff;
		ArrayList<CFBamStringColBuff> filteredList = new ArrayList<CFBamStringColBuff>();
		CFBamStringColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamStringColBuff buff;
		ArrayList<CFBamStringColBuff> filteredList = new ArrayList<CFBamStringColBuff>();
		CFBamStringColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	/**
	 *	Read a page array of the specific StringCol buffer instances identified by the duplicate key TableIdx.
	 *
	 ...
	 */
	public CFBamStringColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		return( (CFBamStringColBuff)editCur );
	}
