...
// Description: Java 11 in-memory RAM DbIO implementation for Int16Col.
	...
	implements ICFBamInt16ColTable
{
	...
	public CFBamRamInt16ColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamInt16ColBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a85c" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a85c" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamInt16ColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamInt16ColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamInt16ColBuff buff;
		ArrayList<CFBamInt16ColBuff> filteredList = new ArrayList<CFBamInt16ColBuff>();
		CFBamInt16ColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamInt16ColBuff buff;
		ArrayList<CFBamInt16ColBuff> filteredList = new ArrayList<CFBamInt16ColBuff>();
		CFBamInt16ColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamInt16ColBuff buff;
		ArrayList<CFBamInt16ColBuff> filteredList = new ArrayList<CFBamInt16ColBuff>();
		CFBamInt16ColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamInt16ColBuff buff;
		ArrayList<CFBamInt16ColBuff> filteredList = new ArrayList<CFBamInt16ColBuff>();
		CFBamInt16ColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamInt16ColBuff buff;
		ArrayList<CFBamInt16ColBuff> filteredList = new ArrayList<CFBamInt16ColBuff>();
		CFBamInt16ColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamInt16ColBuff buff;
		ArrayList<CFBamInt16ColBuff> filteredList = new ArrayList<CFBamInt16ColBuff>();
		CFBamInt16ColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamInt16ColBuff buff;
		ArrayList<CFBamInt16ColBuff> filteredList = new ArrayList<CFBamInt16ColBuff>();
		CFBamInt16ColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	 ...
	 */
	public CFBamInt16ColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		return( (CFBamInt16ColBuff)editCur );
	}
		...
		CFBamInt16ColByTableIdxKey argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableInt16Col().readDerivedByIdIdx( Authorization,
