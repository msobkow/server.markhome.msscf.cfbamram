...
/*
 *	CFBamRamTSecGrpMembTable in-memory RAM DbIO implementation
 *	for TSecGrpMemb.
 */
public class CFBamRamTSecGrpMembTable
	implements ICFBamTSecGrpMembTable
{
	...
	public CFBamRamTSecGrpMembTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecTSecGrpMembBuff Buff )
	{
		...
		pkey.setRequiredTSecGrpMembId( ((CFBamRamTenantTable)schema.getTableTenant()).nextTSecGrpMembIdGen( Authorization,
	...
	public CFSecTSecGrpMembBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		final String S_ProcName = "CFBamRamTSecGrpMemb.readAllDerived";
	...
	{
		final String S_ProcName = "CFBamRamTSecGrpMemb.readAllBuff";
		CFSecTSecGrpMembBuff buff;
	...
	public CFSecTSecGrpMembBuff[] readBuffByTenantIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamTSecGrpMemb.readBuffByTenantIdx() ";
		CFSecTSecGrpMembBuff buff;
		ArrayList<CFSecTSecGrpMembBuff> filteredList = new ArrayList<CFSecTSecGrpMembBuff>();
	...
	public CFSecTSecGrpMembBuff[] readBuffByGroupIdx( CFSecAuthorization Authorization,
		...
		int TSecGroupId )
	{
		final String S_ProcName = "CFBamRamTSecGrpMemb.readBuffByGroupIdx() ";
		CFSecTSecGrpMembBuff buff;
		ArrayList<CFSecTSecGrpMembBuff> filteredList = new ArrayList<CFSecTSecGrpMembBuff>();
	...
	public CFSecTSecGrpMembBuff[] readBuffByUserIdx( CFSecAuthorization Authorization,
		UUID SecUserId )
	{
		final String S_ProcName = "CFBamRamTSecGrpMemb.readBuffByUserIdx() ";
		CFSecTSecGrpMembBuff buff;
		ArrayList<CFSecTSecGrpMembBuff> filteredList = new ArrayList<CFSecTSecGrpMembBuff>();
	...
	public CFSecTSecGrpMembBuff readBuffByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFBamRamTSecGrpMemb.readBuffByUUserIdx() ";
	...
	public void deleteTSecGrpMemb( CFSecAuthorization Authorization,
		CFSecTSecGrpMembBuff Buff )
	{
		final String S_ProcName = "CFBamRamTSecGrpMembTable.deleteTSecGrpMemb() ";
		String classCode;
		CFSecTSecGrpMembPKey pkey = schema.getFactoryTSecGrpMemb().newPKey();
		pkey.setRequiredTenantId( Buff.getRequiredTenantId() );
		pkey.setRequiredTSecGrpMembId( Buff.getRequiredTSecGrpMembId() );
