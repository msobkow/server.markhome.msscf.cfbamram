...
// Description: Java 11 in-memory RAM DbIO implementation for UInt16Def.
	...
	implements ICFBamUInt16DefTable
{
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a84a" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamUInt16DefBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamUInt16DefBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamUInt16DefBuff buff;
		ArrayList<CFBamUInt16DefBuff> filteredList = new ArrayList<CFBamUInt16DefBuff>();
		CFBamUInt16DefBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamUInt16DefBuff buff;
		ArrayList<CFBamUInt16DefBuff> filteredList = new ArrayList<CFBamUInt16DefBuff>();
		CFBamUInt16DefBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamUInt16DefBuff buff;
		ArrayList<CFBamUInt16DefBuff> filteredList = new ArrayList<CFBamUInt16DefBuff>();
		CFBamUInt16DefBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamUInt16DefBuff buff;
		ArrayList<CFBamUInt16DefBuff> filteredList = new ArrayList<CFBamUInt16DefBuff>();
		CFBamUInt16DefBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamUInt16DefBuff buff;
		ArrayList<CFBamUInt16DefBuff> filteredList = new ArrayList<CFBamUInt16DefBuff>();
		CFBamUInt16DefBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamUInt16DefBuff buff;
		ArrayList<CFBamUInt16DefBuff> filteredList = new ArrayList<CFBamUInt16DefBuff>();
		CFBamUInt16DefBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamUInt16DefBuff buff;
		ArrayList<CFBamUInt16DefBuff> filteredList = new ArrayList<CFBamUInt16DefBuff>();
		CFBamUInt16DefBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
