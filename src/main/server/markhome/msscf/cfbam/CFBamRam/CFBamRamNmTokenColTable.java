...
// Description: Java 11 in-memory RAM DbIO implementation for NmTokenCol.
	...
	implements ICFBamNmTokenColTable
{
	...
	public CFBamRamNmTokenColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamNmTokenColBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a85f" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a85f" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamNmTokenColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamNmTokenColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamNmTokenColBuff buff;
		ArrayList<CFBamNmTokenColBuff> filteredList = new ArrayList<CFBamNmTokenColBuff>();
		CFBamNmTokenColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamNmTokenColBuff buff;
		ArrayList<CFBamNmTokenColBuff> filteredList = new ArrayList<CFBamNmTokenColBuff>();
		CFBamNmTokenColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamNmTokenColBuff buff;
		ArrayList<CFBamNmTokenColBuff> filteredList = new ArrayList<CFBamNmTokenColBuff>();
		CFBamNmTokenColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamNmTokenColBuff buff;
		ArrayList<CFBamNmTokenColBuff> filteredList = new ArrayList<CFBamNmTokenColBuff>();
		CFBamNmTokenColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamNmTokenColBuff buff;
		ArrayList<CFBamNmTokenColBuff> filteredList = new ArrayList<CFBamNmTokenColBuff>();
		CFBamNmTokenColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamNmTokenColBuff buff;
		ArrayList<CFBamNmTokenColBuff> filteredList = new ArrayList<CFBamNmTokenColBuff>();
		CFBamNmTokenColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamNmTokenColBuff buff;
		ArrayList<CFBamNmTokenColBuff> filteredList = new ArrayList<CFBamNmTokenColBuff>();
		CFBamNmTokenColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	/**
	 *	Read a page array of the specific NmTokenCol buffer instances identified by the duplicate key TableIdx.
	 *
	 ...
	 */
	public CFBamNmTokenColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		{
			return( (CFBamNmTokenColBuff)cur );
		}
		...
		return( (CFBamNmTokenColBuff)editCur );
	}
		...
		CFBamNmTokenColByTableIdxKey argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableNmTokenCol().readDerivedByIdIdx( Authorization,
