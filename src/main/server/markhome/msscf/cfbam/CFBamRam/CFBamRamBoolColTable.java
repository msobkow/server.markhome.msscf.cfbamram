...
// Description: Java 11 in-memory RAM DbIO implementation for BoolCol.
	...
	implements ICFBamBoolColTable
{
	...
	public CFBamRamBoolColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		long Id )
	{
		...
		CFBamBoolColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamBoolColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamBoolColBuff buff;
		ArrayList<CFBamBoolColBuff> filteredList = new ArrayList<CFBamBoolColBuff>();
		CFBamBoolColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamBoolColBuff buff;
		ArrayList<CFBamBoolColBuff> filteredList = new ArrayList<CFBamBoolColBuff>();
		CFBamBoolColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamBoolColBuff buff;
		ArrayList<CFBamBoolColBuff> filteredList = new ArrayList<CFBamBoolColBuff>();
		CFBamBoolColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamBoolColBuff buff;
		ArrayList<CFBamBoolColBuff> filteredList = new ArrayList<CFBamBoolColBuff>();
		CFBamBoolColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamBoolColBuff buff;
		ArrayList<CFBamBoolColBuff> filteredList = new ArrayList<CFBamBoolColBuff>();
		CFBamBoolColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamBoolColBuff buff;
		ArrayList<CFBamBoolColBuff> filteredList = new ArrayList<CFBamBoolColBuff>();
		CFBamBoolColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamBoolColBuff buff;
		ArrayList<CFBamBoolColBuff> filteredList = new ArrayList<CFBamBoolColBuff>();
		CFBamBoolColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	 ...
	 */
	public CFBamBoolColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		return( (CFBamBoolColBuff)editCur );
	}
		...
		CFBamBoolColByTableIdxKey argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableBoolCol().readDerivedByIdIdx( Authorization,
