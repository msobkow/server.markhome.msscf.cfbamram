...
// Description: Java 11 in-memory RAM DbIO implementation for Int32Type.
	...
	implements ICFBamInt32TypeTable
{
	...
	public CFBamRamInt32TypeTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamInt32TypeBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a826" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a826" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamInt32TypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamInt32TypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamInt32TypeBuff buff;
		ArrayList<CFBamInt32TypeBuff> filteredList = new ArrayList<CFBamInt32TypeBuff>();
		CFBamInt32TypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamInt32TypeBuff buff;
		ArrayList<CFBamInt32TypeBuff> filteredList = new ArrayList<CFBamInt32TypeBuff>();
		CFBamInt32TypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamInt32TypeBuff buff;
		ArrayList<CFBamInt32TypeBuff> filteredList = new ArrayList<CFBamInt32TypeBuff>();
		CFBamInt32TypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamInt32TypeBuff buff;
		ArrayList<CFBamInt32TypeBuff> filteredList = new ArrayList<CFBamInt32TypeBuff>();
		CFBamInt32TypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamInt32TypeBuff buff;
		ArrayList<CFBamInt32TypeBuff> filteredList = new ArrayList<CFBamInt32TypeBuff>();
		CFBamInt32TypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamInt32TypeBuff buff;
		ArrayList<CFBamInt32TypeBuff> filteredList = new ArrayList<CFBamInt32TypeBuff>();
		CFBamInt32TypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamInt32TypeBuff buff;
		ArrayList<CFBamInt32TypeBuff> filteredList = new ArrayList<CFBamInt32TypeBuff>();
		CFBamInt32TypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	/**
	 *	Read a page array of the specific Int32Type buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamInt32TypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		return( (CFBamInt32TypeBuff)editCur );
	}
