...
// Description: Java 11 in-memory RAM DbIO implementation for DoubleType.
	...
	implements ICFBamDoubleTypeTable
{
	...
	public CFBamRamDoubleTypeTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamDoubleTypeBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a81d" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a81d" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamDoubleTypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamDoubleTypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamDoubleTypeBuff buff;
		ArrayList<CFBamDoubleTypeBuff> filteredList = new ArrayList<CFBamDoubleTypeBuff>();
		CFBamDoubleTypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamDoubleTypeBuff buff;
		ArrayList<CFBamDoubleTypeBuff> filteredList = new ArrayList<CFBamDoubleTypeBuff>();
		CFBamDoubleTypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamDoubleTypeBuff buff;
		ArrayList<CFBamDoubleTypeBuff> filteredList = new ArrayList<CFBamDoubleTypeBuff>();
		CFBamDoubleTypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamDoubleTypeBuff buff;
		ArrayList<CFBamDoubleTypeBuff> filteredList = new ArrayList<CFBamDoubleTypeBuff>();
		CFBamDoubleTypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamDoubleTypeBuff buff;
		ArrayList<CFBamDoubleTypeBuff> filteredList = new ArrayList<CFBamDoubleTypeBuff>();
		CFBamDoubleTypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamDoubleTypeBuff buff;
		ArrayList<CFBamDoubleTypeBuff> filteredList = new ArrayList<CFBamDoubleTypeBuff>();
		CFBamDoubleTypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamDoubleTypeBuff buff;
		ArrayList<CFBamDoubleTypeBuff> filteredList = new ArrayList<CFBamDoubleTypeBuff>();
		CFBamDoubleTypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	/**
	 *	Read a page array of the specific DoubleType buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamDoubleTypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		{
			return( (CFBamDoubleTypeBuff)cur );
		}
		...
		return( (CFBamDoubleTypeBuff)editCur );
	}
		...
		CFBamDoubleTypeBySchemaIdxKey argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDoubleType().readDerivedByIdIdx( Authorization,
