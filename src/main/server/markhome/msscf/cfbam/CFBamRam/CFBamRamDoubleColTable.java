...
// Description: Java 11 in-memory RAM DbIO implementation for DoubleCol.
	...
	implements ICFBamDoubleColTable
{
	...
	public CFBamRamDoubleColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamDoubleColBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a855" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a855" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamDoubleColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamDoubleColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamDoubleColBuff buff;
		ArrayList<CFBamDoubleColBuff> filteredList = new ArrayList<CFBamDoubleColBuff>();
		CFBamDoubleColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamDoubleColBuff buff;
		ArrayList<CFBamDoubleColBuff> filteredList = new ArrayList<CFBamDoubleColBuff>();
		CFBamDoubleColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamDoubleColBuff buff;
		ArrayList<CFBamDoubleColBuff> filteredList = new ArrayList<CFBamDoubleColBuff>();
		CFBamDoubleColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamDoubleColBuff buff;
		ArrayList<CFBamDoubleColBuff> filteredList = new ArrayList<CFBamDoubleColBuff>();
		CFBamDoubleColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamDoubleColBuff buff;
		ArrayList<CFBamDoubleColBuff> filteredList = new ArrayList<CFBamDoubleColBuff>();
		CFBamDoubleColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamDoubleColBuff buff;
		ArrayList<CFBamDoubleColBuff> filteredList = new ArrayList<CFBamDoubleColBuff>();
		CFBamDoubleColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamDoubleColBuff buff;
		ArrayList<CFBamDoubleColBuff> filteredList = new ArrayList<CFBamDoubleColBuff>();
		CFBamDoubleColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	/**
	 *	Read a page array of the specific DoubleCol buffer instances identified by the duplicate key TableIdx.
	 *
	 ...
	 */
	public CFBamDoubleColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		return( (CFBamDoubleColBuff)editCur );
	}
		...
		CFBamDoubleColByTableIdxKey argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableDoubleCol().readDerivedByIdIdx( Authorization,
