...
// Description: Java 11 in-memory RAM DbIO implementation for TokenType.
	...
	implements ICFBamTokenTypeTable
{
	...
	public CFBamRamTokenTypeTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamTokenTypeBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a849" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a849" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamTokenTypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamTokenTypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamTokenTypeBuff buff;
		ArrayList<CFBamTokenTypeBuff> filteredList = new ArrayList<CFBamTokenTypeBuff>();
		CFBamTokenTypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamTokenTypeBuff buff;
		ArrayList<CFBamTokenTypeBuff> filteredList = new ArrayList<CFBamTokenTypeBuff>();
		CFBamTokenTypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamTokenTypeBuff buff;
		ArrayList<CFBamTokenTypeBuff> filteredList = new ArrayList<CFBamTokenTypeBuff>();
		CFBamTokenTypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamTokenTypeBuff buff;
		ArrayList<CFBamTokenTypeBuff> filteredList = new ArrayList<CFBamTokenTypeBuff>();
		CFBamTokenTypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamTokenTypeBuff buff;
		ArrayList<CFBamTokenTypeBuff> filteredList = new ArrayList<CFBamTokenTypeBuff>();
		CFBamTokenTypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamTokenTypeBuff buff;
		ArrayList<CFBamTokenTypeBuff> filteredList = new ArrayList<CFBamTokenTypeBuff>();
		CFBamTokenTypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamTokenTypeBuff buff;
		ArrayList<CFBamTokenTypeBuff> filteredList = new ArrayList<CFBamTokenTypeBuff>();
		CFBamTokenTypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	/**
	 *	Read a page array of the specific TokenType buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamTokenTypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		return( (CFBamTokenTypeBuff)editCur );
	}
