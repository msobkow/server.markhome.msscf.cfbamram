...
// Description: Java 11 in-memory RAM DbIO implementation for Int32Col.
	...
	implements ICFBamInt32ColTable
{
	...
	public CFBamRamInt32ColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamInt32ColBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a85d" ) ) {
		...
		long Id )
	{
		...
		CFBamInt32ColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamInt32ColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamInt32ColBuff buff;
		ArrayList<CFBamInt32ColBuff> filteredList = new ArrayList<CFBamInt32ColBuff>();
		CFBamInt32ColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamInt32ColBuff buff;
		ArrayList<CFBamInt32ColBuff> filteredList = new ArrayList<CFBamInt32ColBuff>();
		CFBamInt32ColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamInt32ColBuff buff;
		ArrayList<CFBamInt32ColBuff> filteredList = new ArrayList<CFBamInt32ColBuff>();
		CFBamInt32ColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamInt32ColBuff buff;
		ArrayList<CFBamInt32ColBuff> filteredList = new ArrayList<CFBamInt32ColBuff>();
		CFBamInt32ColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamInt32ColBuff buff;
		ArrayList<CFBamInt32ColBuff> filteredList = new ArrayList<CFBamInt32ColBuff>();
		CFBamInt32ColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamInt32ColBuff buff;
		ArrayList<CFBamInt32ColBuff> filteredList = new ArrayList<CFBamInt32ColBuff>();
		CFBamInt32ColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamInt32ColBuff buff;
		ArrayList<CFBamInt32ColBuff> filteredList = new ArrayList<CFBamInt32ColBuff>();
		CFBamInt32ColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	/**
	 *	Read a page array of the specific Int32Col buffer instances identified by the duplicate key TableIdx.
	 *
	 ...
	 */
	public CFBamInt32ColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		return( (CFBamInt32ColBuff)editCur );
	}
		...
		CFBamInt32ColByTableIdxKey argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableInt32Col().readDerivedByIdIdx( Authorization,
