...
// Description: Java 11 in-memory RAM DbIO implementation for NumberCol.
	...
	implements ICFBamNumberColTable
{
	...
	public CFBamRamNumberColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamNumberColBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a861" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a861" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamNumberColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamNumberColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamNumberColBuff buff;
		ArrayList<CFBamNumberColBuff> filteredList = new ArrayList<CFBamNumberColBuff>();
		CFBamNumberColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamNumberColBuff buff;
		ArrayList<CFBamNumberColBuff> filteredList = new ArrayList<CFBamNumberColBuff>();
		CFBamNumberColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamNumberColBuff buff;
		ArrayList<CFBamNumberColBuff> filteredList = new ArrayList<CFBamNumberColBuff>();
		CFBamNumberColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamNumberColBuff buff;
		ArrayList<CFBamNumberColBuff> filteredList = new ArrayList<CFBamNumberColBuff>();
		CFBamNumberColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamNumberColBuff buff;
		ArrayList<CFBamNumberColBuff> filteredList = new ArrayList<CFBamNumberColBuff>();
		CFBamNumberColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamNumberColBuff buff;
		ArrayList<CFBamNumberColBuff> filteredList = new ArrayList<CFBamNumberColBuff>();
		CFBamNumberColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamNumberColBuff buff;
		ArrayList<CFBamNumberColBuff> filteredList = new ArrayList<CFBamNumberColBuff>();
		CFBamNumberColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	/**
	 *	Read a page array of the specific NumberCol buffer instances identified by the duplicate key TableIdx.
	 *
	 ...
	 */
	public CFBamNumberColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		return( (CFBamNumberColBuff)editCur );
	}
		...
		CFBamNumberColByTableIdxKey argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableNumberCol().readDerivedByIdIdx( Authorization,
