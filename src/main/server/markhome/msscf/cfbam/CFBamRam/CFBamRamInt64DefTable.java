...
// Description: Java 11 in-memory RAM DbIO implementation for Int64Def.
	...
	implements ICFBamInt64DefTable
{
		...
		long Id )
	{
		...
		CFBamInt64DefBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamInt64DefBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamInt64DefBuff buff;
		ArrayList<CFBamInt64DefBuff> filteredList = new ArrayList<CFBamInt64DefBuff>();
		CFBamInt64DefBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamInt64DefBuff buff;
		ArrayList<CFBamInt64DefBuff> filteredList = new ArrayList<CFBamInt64DefBuff>();
		CFBamInt64DefBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamInt64DefBuff buff;
		ArrayList<CFBamInt64DefBuff> filteredList = new ArrayList<CFBamInt64DefBuff>();
		CFBamInt64DefBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamInt64DefBuff buff;
		ArrayList<CFBamInt64DefBuff> filteredList = new ArrayList<CFBamInt64DefBuff>();
		CFBamInt64DefBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamInt64DefBuff buff;
		ArrayList<CFBamInt64DefBuff> filteredList = new ArrayList<CFBamInt64DefBuff>();
		CFBamInt64DefBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamInt64DefBuff buff;
		ArrayList<CFBamInt64DefBuff> filteredList = new ArrayList<CFBamInt64DefBuff>();
		CFBamInt64DefBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamInt64DefBuff buff;
		ArrayList<CFBamInt64DefBuff> filteredList = new ArrayList<CFBamInt64DefBuff>();
		CFBamInt64DefBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
