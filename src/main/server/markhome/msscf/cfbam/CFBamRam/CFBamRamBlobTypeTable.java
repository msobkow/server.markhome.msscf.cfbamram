...
// Description: Java 11 in-memory RAM DbIO implementation for BlobType.
	...
	implements ICFBamBlobTypeTable
{
	...
	public CFBamRamBlobTypeTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamBlobTypeBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a80c" ) ) {
		...
		long Id )
	{
		...
		CFBamBlobTypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamBlobTypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamBlobTypeBuff buff;
		ArrayList<CFBamBlobTypeBuff> filteredList = new ArrayList<CFBamBlobTypeBuff>();
		CFBamBlobTypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamBlobTypeBuff buff;
		ArrayList<CFBamBlobTypeBuff> filteredList = new ArrayList<CFBamBlobTypeBuff>();
		CFBamBlobTypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamBlobTypeBuff buff;
		ArrayList<CFBamBlobTypeBuff> filteredList = new ArrayList<CFBamBlobTypeBuff>();
		CFBamBlobTypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamBlobTypeBuff buff;
		ArrayList<CFBamBlobTypeBuff> filteredList = new ArrayList<CFBamBlobTypeBuff>();
		CFBamBlobTypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamBlobTypeBuff buff;
		ArrayList<CFBamBlobTypeBuff> filteredList = new ArrayList<CFBamBlobTypeBuff>();
		CFBamBlobTypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamBlobTypeBuff buff;
		ArrayList<CFBamBlobTypeBuff> filteredList = new ArrayList<CFBamBlobTypeBuff>();
		CFBamBlobTypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamBlobTypeBuff buff;
		ArrayList<CFBamBlobTypeBuff> filteredList = new ArrayList<CFBamBlobTypeBuff>();
		CFBamBlobTypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	 ...
	 */
	public CFBamBlobTypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		return( (CFBamBlobTypeBuff)editCur );
	}
		...
		CFBamBlobTypeBySchemaIdxKey argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableBlobType().readDerivedByIdIdx( Authorization,
