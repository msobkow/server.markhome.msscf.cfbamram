...
/*
 *	CFBamRamTSecGrpIncTable in-memory RAM DbIO implementation
 *	for TSecGrpInc.
 */
public class CFBamRamTSecGrpIncTable
	implements ICFBamTSecGrpIncTable
{
	...
	public CFBamRamTSecGrpIncTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecTSecGrpIncBuff Buff )
	{
		...
		pkey.setRequiredTSecGrpIncId( ((CFBamRamTenantTable)schema.getTableTenant()).nextTSecGrpIncIdGen( Authorization,
	...
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readDerived";
	...
	public CFSecTSecGrpIncBuff[] readDerivedByTenantIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readDerivedByTenantIdx";
	...
	public CFSecTSecGrpIncBuff[] readDerivedByGroupIdx( CFSecAuthorization Authorization,
		...
		int TSecGroupId )
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readDerivedByGroupIdx";
	...
	public CFSecTSecGrpIncBuff[] readDerivedByIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readDerivedByIncludeIdx";
	...
	public CFSecTSecGrpIncBuff readDerivedByUIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readDerivedByUIncludeIdx";
	...
	public CFSecTSecGrpIncBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long TSecGrpIncId )
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readDerivedByIdIdx() ";
		CFSecTSecGrpIncPKey key = schema.getFactoryTSecGrpInc().newPKey();
		key.setRequiredTenantId( TenantId );
	...
	public CFSecTSecGrpIncBuff readBuff( CFSecAuthorization Authorization,
		CFSecTSecGrpIncPKey PKey )
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readBuff";
	...
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readAllBuff";
		CFSecTSecGrpIncBuff buff;
	...
	public CFSecTSecGrpIncBuff readBuffByIdIdx( CFSecAuthorization Authorization,
		...
		long TSecGrpIncId )
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readBuffByIdIdx() ";
	...
	public CFSecTSecGrpIncBuff[] readBuffByTenantIdx( CFSecAuthorization Authorization,
		long TenantId )
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readBuffByTenantIdx() ";
		CFSecTSecGrpIncBuff buff;
		ArrayList<CFSecTSecGrpIncBuff> filteredList = new ArrayList<CFSecTSecGrpIncBuff>();
	...
	public CFSecTSecGrpIncBuff[] readBuffByGroupIdx( CFSecAuthorization Authorization,
		...
		int TSecGroupId )
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readBuffByGroupIdx() ";
		CFSecTSecGrpIncBuff buff;
		ArrayList<CFSecTSecGrpIncBuff> filteredList = new ArrayList<CFSecTSecGrpIncBuff>();
	...
	public CFSecTSecGrpIncBuff[] readBuffByIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readBuffByIncludeIdx() ";
		CFSecTSecGrpIncBuff buff;
		ArrayList<CFSecTSecGrpIncBuff> filteredList = new ArrayList<CFSecTSecGrpIncBuff>();
	...
	public CFSecTSecGrpIncBuff readBuffByUIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFBamRamTSecGrpInc.readBuffByUIncludeIdx() ";
