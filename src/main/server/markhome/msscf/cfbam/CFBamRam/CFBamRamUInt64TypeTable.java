...
// Description: Java 11 in-memory RAM DbIO implementation for UInt64Type.
	...
	implements ICFBamUInt64TypeTable
{
	...
	public CFBamRamUInt64TypeTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamUInt64TypeBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a84f" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a84f" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamUInt64TypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamUInt64TypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamUInt64TypeBuff buff;
		ArrayList<CFBamUInt64TypeBuff> filteredList = new ArrayList<CFBamUInt64TypeBuff>();
		CFBamUInt64TypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamUInt64TypeBuff buff;
		ArrayList<CFBamUInt64TypeBuff> filteredList = new ArrayList<CFBamUInt64TypeBuff>();
		CFBamUInt64TypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamUInt64TypeBuff buff;
		ArrayList<CFBamUInt64TypeBuff> filteredList = new ArrayList<CFBamUInt64TypeBuff>();
		CFBamUInt64TypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamUInt64TypeBuff buff;
		ArrayList<CFBamUInt64TypeBuff> filteredList = new ArrayList<CFBamUInt64TypeBuff>();
		CFBamUInt64TypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamUInt64TypeBuff buff;
		ArrayList<CFBamUInt64TypeBuff> filteredList = new ArrayList<CFBamUInt64TypeBuff>();
		CFBamUInt64TypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamUInt64TypeBuff buff;
		ArrayList<CFBamUInt64TypeBuff> filteredList = new ArrayList<CFBamUInt64TypeBuff>();
		CFBamUInt64TypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamUInt64TypeBuff buff;
		ArrayList<CFBamUInt64TypeBuff> filteredList = new ArrayList<CFBamUInt64TypeBuff>();
		CFBamUInt64TypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	/**
	 *	Read a page array of the specific UInt64Type buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamUInt64TypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		{
			return( (CFBamUInt64TypeBuff)cur );
		}
		...
		return( (CFBamUInt64TypeBuff)editCur );
	}
		...
		CFBamUInt64TypeBySchemaIdxKey argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableUInt64Type().readDerivedByIdIdx( Authorization,
