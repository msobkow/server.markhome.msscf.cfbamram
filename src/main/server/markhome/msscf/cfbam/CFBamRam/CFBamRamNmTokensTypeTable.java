...
// Description: Java 11 in-memory RAM DbIO implementation for NmTokensType.
	...
	implements ICFBamNmTokensTypeTable
{
	...
	public CFBamRamNmTokensTypeTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamNmTokensTypeBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a82c" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a82c" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamNmTokensTypeBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamNmTokensTypeBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamNmTokensTypeBuff buff;
		ArrayList<CFBamNmTokensTypeBuff> filteredList = new ArrayList<CFBamNmTokensTypeBuff>();
		CFBamNmTokensTypeBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamNmTokensTypeBuff buff;
		ArrayList<CFBamNmTokensTypeBuff> filteredList = new ArrayList<CFBamNmTokensTypeBuff>();
		CFBamNmTokensTypeBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamNmTokensTypeBuff buff;
		ArrayList<CFBamNmTokensTypeBuff> filteredList = new ArrayList<CFBamNmTokensTypeBuff>();
		CFBamNmTokensTypeBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamNmTokensTypeBuff buff;
		ArrayList<CFBamNmTokensTypeBuff> filteredList = new ArrayList<CFBamNmTokensTypeBuff>();
		CFBamNmTokensTypeBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamNmTokensTypeBuff buff;
		ArrayList<CFBamNmTokensTypeBuff> filteredList = new ArrayList<CFBamNmTokensTypeBuff>();
		CFBamNmTokensTypeBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamNmTokensTypeBuff buff;
		ArrayList<CFBamNmTokensTypeBuff> filteredList = new ArrayList<CFBamNmTokensTypeBuff>();
		CFBamNmTokensTypeBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamNmTokensTypeBuff buff;
		ArrayList<CFBamNmTokensTypeBuff> filteredList = new ArrayList<CFBamNmTokensTypeBuff>();
		CFBamNmTokensTypeBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	/**
	 *	Read a page array of the specific NmTokensType buffer instances identified by the duplicate key SchemaIdx.
	 *
	 ...
	 */
	public CFBamNmTokensTypeBuff[] pageBuffBySchemaIdx( CFSecAuthorization Authorization,
		long TenantId,
		long SchemaDefId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		{
			return( (CFBamNmTokensTypeBuff)cur );
		}
		...
		return( (CFBamNmTokensTypeBuff)editCur );
	}
		...
		CFBamNmTokensTypeBySchemaIdxKey argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			cur = iterMatch.next();
			cur = schema.getTableNmTokensType().readDerivedByIdIdx( Authorization,
