...
// Description: Java 11 in-memory RAM DbIO implementation for NmTokensCol.
	...
	implements ICFBamNmTokensColTable
{
	...
	public CFBamRamNmTokensColTable( ICFBamSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFBamNmTokensColBuff Buff )
	{
		...
		if( Buff.getClassCode().equals( "a860" ) ) {
		...
		CFBamValuePKey PKey )
	{
		...
		if( ( buff != null ) && ( ! buff.getClassCode().equals( "a860" ) ) ) {
			buff = null;
		}
		return( buff );
	}
		...
		long Id )
	{
		...
		CFBamNmTokensColBuff buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		...
		String Name )
	{
		...
		CFBamNmTokensColBuff buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long TenantId )
	{
		...
		CFBamNmTokensColBuff buff;
		ArrayList<CFBamNmTokensColBuff> filteredList = new ArrayList<CFBamNmTokensColBuff>();
		CFBamNmTokensColBuff[] buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
			if( ( buff != null ) && buff.getClassCode().equals( "a809" ) ) {
		...
		long ScopeId )
	{
		...
		CFBamNmTokensColBuff buff;
		ArrayList<CFBamNmTokensColBuff> filteredList = new ArrayList<CFBamNmTokensColBuff>();
		CFBamNmTokensColBuff[] buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long DefSchemaId )
	{
		...
		CFBamNmTokensColBuff buff;
		ArrayList<CFBamNmTokensColBuff> filteredList = new ArrayList<CFBamNmTokensColBuff>();
		CFBamNmTokensColBuff[] buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamNmTokensColBuff buff;
		ArrayList<CFBamNmTokensColBuff> filteredList = new ArrayList<CFBamNmTokensColBuff>();
		CFBamNmTokensColBuff[] buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long NextId )
	{
		...
		CFBamNmTokensColBuff buff;
		ArrayList<CFBamNmTokensColBuff> filteredList = new ArrayList<CFBamNmTokensColBuff>();
		CFBamNmTokensColBuff[] buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
			buff = buffList[idx];
		...
		Long PrevId )
	{
		...
		CFBamNmTokensColBuff buff;
		ArrayList<CFBamNmTokensColBuff> filteredList = new ArrayList<CFBamNmTokensColBuff>();
		CFBamNmTokensColBuff[] buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Long NextId )
	{
		...
		CFBamNmTokensColBuff buff;
		ArrayList<CFBamNmTokensColBuff> filteredList = new ArrayList<CFBamNmTokensColBuff>();
		CFBamNmTokensColBuff[] buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	/**
	 *	Read a page array of the specific NmTokensCol buffer instances identified by the duplicate key TableIdx.
	 *
	 ...
	 */
	public CFBamNmTokensColBuff[] pageBuffByTableIdx( CFSecAuthorization Authorization,
		long TenantId,
		long TableId,
		Long priorTenantId,
		Long priorId )
		...
		int revision )
	{
		...
		{
			return( (CFBamNmTokensColBuff)cur );
		}
		...
		return( (CFBamNmTokensColBuff)editCur );
	}
